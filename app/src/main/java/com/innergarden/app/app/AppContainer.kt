...
import com.innergarden.app.data.ai.AiRepositoryImpl
import com.innergarden.app.data.ai.FirebaseGeminiDataSource
...
object AppContainer {
    ...
    private val aiRepository = AiRepositoryImpl(FirebaseGeminiDataSource())
    ...
    val generateReflectionGuidance = GenerateReflectionGuidanceUseCase(aiRepository, getPlaceholderReflectionGuidance)
    val getRecentReflections = GetRecentReflectionsUseCase(getRecentCheckIns)
    val generateWeeklyDeclutter = GenerateWeeklyDeclutterUseCase(aiRepository)
}
